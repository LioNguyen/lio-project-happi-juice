...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      'fixed inset-0 z-50 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 bg-black/20',
      className,
    )}
    {...props}
    ref={ref}
...
interface SheetContentProps
  ...
  closeProps?: React.ComponentPropsWithoutRef<typeof SheetClose>
}
...
>(
  (
    { side = 'right', className, children, overlayProps, closeProps, ...props },
    ref,
  ) => (
    <SheetPortal>
